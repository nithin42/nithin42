...
* **AI & Data Systems:** Transformers, Feast (Feature Stores), PyTorch, Ray, AWS DynamoDB, Redis, NumPy, pandas
...
* Contributing to **Hugging Face Transformers** (Inference Pipelines & Generative AI), **Cloudflare Workers SDK**, **Feast** (Feature Stores & MCP), and **Meta / Hydra** ecosystems.
